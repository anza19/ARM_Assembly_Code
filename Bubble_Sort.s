...
_start:
				...
				MOV R5, #1		//R5 will act both as a counter in our bubble sort funct and the flag for outer loop
...
WHILE_LOOP:
				...
				BEQ CHECK		//If condition flags are satisifed, we are at the end, we simply hit the end
				...
				B   BUBBLE_SORT		//Begin first round of sorting
...
CHECK:				LDR R6, =FIRST		//Load first address to check if sorting executed correctly
